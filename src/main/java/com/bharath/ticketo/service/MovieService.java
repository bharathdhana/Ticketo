...
public interface MovieService {
    MovieResponse addMovie(MovieRequest request, MultipartFile file) throws IOException;
    MovieResponse updateMovie(MovieRequest request, Long id, MultipartFile file) throws IOException;
